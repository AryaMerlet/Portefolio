...
<nav>
    ...
    <div class="config_container">
        <?php
        //echo "SESSION : " . $_SESSION['Mode'];
        //echo "<br>REQUEST : " . $_REQUEST['Mode'];
        //
        ?>
        <form action="configuration.php" method="get" id="formName">
            <input type="hidden" name="config" id="config" value="config">
            <input name="Mode" onchange="form.submit()" type="checkbox"  class="darklight" id = "checkbox" <?php if ($_SESSION['Mode'] == 'jour'){echo 'checked';}?>>
        </form>
