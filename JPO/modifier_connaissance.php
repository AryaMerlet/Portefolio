...
if (isset($_REQUEST['id'])) {
    ...
    $sql = "SELECT * FROM connaissance WHERE id_connaissance = :id";
...
<nav>
    ...
    <div class="sun">
        ...
        <form action="modifier_connaissance.php?id=<?php echo $id; ?>" method="post">
            <div class="label_box">
                <label for="moyen">moyen : </label>
                <input type="text" name="moyen" id="moyen" value="<?php echo $moyen; ?>" required />
        </div>
            <input type="submit" name="soumettre" onclick="myFunction()" value="modifier" />
        </form>
            <div class="retour-modif">
                <a href="reglage.php">Retour</a>
            </div>
        </div>
